        ...
        <div className={styles.Accessibility}>
            ...
            <ul className={styles.guidelines}>
                <li className={styles.guideline}>
                    <a href="https://www.w3.org/WAI/standards-guidelines/wcag/" className={styles.a}>
                        WCAG guidelines
                    </a>
                </li>
                <li className={styles.guideline}>
                    <a className={styles.a} href="https://www.section508.gov/manage/laws-and-policies/">
                        Section 508
                    </a>
                </li>
                <li className={styles.guideline}>
                    <a href="https://www.ada.gov/law-and-regs/design-standards/" className={styles.a}>
                        ADA
                    </a>
                </li>
            </ul>
